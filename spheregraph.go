...
func subdivideFace(face Face) []Face {
  ...
  set := []Face {
    ...
    Face {parentIndex: parent, index:count + 1, a: 0, b: count, c: 0, done: false,}, // sub 1
    Face {parentIndex: parent, index:count + 2, a: count, b: 0, c: 0, done: false,}, // sub 2
    Face {parentIndex: parent, index:count + 3, a: 0, b: 0, c: count, done: false,}, // sub 3
  }
  return set
}
